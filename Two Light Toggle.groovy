...
preferences {
    ...
    section("<b>Lights</b>") {
		...
		if (colorToggle) {
			if (priTempToggle) {
				input "priTempVal", "integer", title: "Primary Temperature", range: "1500..9000", width: 4, defaultValue: 4500
				input "priTempLevel", "integer", title: "Primary level", range: "0..100", width: 4, defaultValue: 50
			} else {
				input "priColorHue", "integer", title: "Primary Color Hue", range: "0..100", width: 2, defaultValue: 50
				input "priColorSat", "integer", title: "Primary Color Sat", range: "0..100", width: 2, defaultValue: 50
				input "priColorLevel", "integer", title: "Primary Color level", range: "0..100", width: 2, defaultValue: 50
			}
			if (!secRandom) {
				if (secTempToggle) {
					input "secTempVal", "integer", title: "Secondary Temperature", range: "1500..9000", width: 4, defaultValue: 4500
					input "secTempLevel", "integer", title: "Secondary level", range: "0..100", width: 4, defaultValue: 50
				} else {
					input "secColorHue", "integer", title: "Secondary Color Hue", range: "0..100", width: 2, defaultValue: 50
					input "secColorSat", "integer", title: "Secondary Color Sat", range: "0..100", width: 2, defaultValue: 50
					input "secColorLevel", "integer", title: "Secondary Color level", range: "0..100", width: 2, defaultValue: 50
				}
			}
